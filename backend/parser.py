...
api = API('1bf084b6fbb0a523f4e6c9281c019a5c97282440444bca8311d958c73ff8e1eef70ceda5b5a5e88fef509')

def get_wall_posts(group_name):
    url = f"https://api.vk.com/method/wall.get?domain={group_name}&count=40&access_token={api}&v=5.52"
